...
echo '<br>' . $lista[1]; // Retorna o conteúdo do índice 0.
echo '<br>' . $lista[2]; // Retorna o conteúdo do índice 0.
echo '<br>' . $lista[3]; // Retorna o conteúdo do índice 0.
echo '<br>' . $lista[4]; // Informando um índice inexiste seráretornado null (nesse caso não será exibido nada na tela)
